        ...
        <div id="mws-sidebar">
        	...
        	<div id="mws-searchbox" class="mws-inset">
            	<form action="typography.html">
                	<input class="mws-search-input" placeholder="闹着玩的...别搜" type="text">
            ...
            <div id="mws-navigation">
                <ul>
                    <li class='closed'>
                        <a href="#"><i class="icon-accessibility-2"></i>用户管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/user/index" class="icon-users">浏览用户</a></li>
                            <li><a href="/admin/user/add" class="icon-add-contact">添加用户</a></li>
                            <li><a href="/admin/user/litter" class="icon-accessibility">禁用名单</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-accessibility-2"></i>后台用户管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/backuser/index" class="icon-users">浏览后台用户</a></li>
                            <li><a href="/admin/backuser/add" class="icon-add-contact">添加后台用户</a></li>
                            <li><a href="/admin/backuser/litter" class="icon-accessibility">禁用后台名单</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-align-justify"></i>商品分类管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/cate/index" class="icon-film">浏览分类</a></li>
                            <li><a href="/admin/cate/add" class="icon-plus-sign">添加分类</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div id="mws-navigation">
                <ul>
                    <li>
                        <a href="#"><i class="icon-pacman"></i>品牌管理</a>
                        <ul class='closed'>
                            <li><a href="/admin/brand/index" class="icon-stats">浏览品牌</a></li>
                            <li><a href="/admin/brand/add" class="icon-yahoo">添加品牌</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
             <div id="mws-navigation">
                <ul>
                    <li>
                        ...
                        <ul class='closed'>
                            <li><a href="/admin/brand/index" class="icon-unlink">浏览商品</a></li>
                            <li><a href="/admin/goods/add" class="icon-gplus">添加商品</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
